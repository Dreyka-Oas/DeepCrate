...
import oas.dreyka.deepcrate.config.bounds.CrateBounds;
import oas.dreyka.deepcrate.config.bounds.ScreenBounds;
 ...
 */
public final class ConfigBoundsTable {
    ...
    public static @Nullable Range get(String name) {
