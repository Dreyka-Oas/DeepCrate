 ...
 */
public final class CrateSlotCount {
    private CrateSlotCount() {}

    public static boolean shortens(Slot slot) {
        return slot instanceof DeepCrateSlot && slot.getItem().getCount() > ScreenConfig.abbreviateAbove;
    }

    public static void render(GuiGraphics guiGraphics, Font font, Slot slot, int imageWidth) {
