 ...
 */
public final class CrateScreenLayout {
    ...
    public CrateScreenLayout(DeepCrateMenu deepCrateMenu) {
    ...
    public void build(DeepCrateScreen screen, PanelArea area, Font font, int inventoryLabelY, Component playerInventoryTitle) {
        this.panelArea = area;
    ...
    public boolean claimsKey(KeyEvent keyEvent) {
