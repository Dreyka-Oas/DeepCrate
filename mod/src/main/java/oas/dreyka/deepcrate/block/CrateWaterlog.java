...
final class CrateWaterlog {
     ...
     */
    static void keepFlowing(BlockState blockState, LevelReader levelReader, ScheduledTickAccess scheduledTickAccess, BlockPos blockPos) {
