...
public final class CrateVanillaStacks {
    ...
    public static List<ItemStack> splitAll(Iterable<ItemStack> slots) {
        List<ItemStack> list = new ArrayList<>();
