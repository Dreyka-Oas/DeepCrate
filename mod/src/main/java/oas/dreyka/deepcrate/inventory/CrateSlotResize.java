 ...
 */
final class CrateSlotResize {
    private final CrateStorage storage;

    CrateSlotResize(CrateStorage storage) {
        this.storage = storage;
    }

    void replaceSlots(NonNullList<ItemStack> nonNullList) {
     ...
     * alone.
     */
    List<ItemStack> trimTo(int slotCount) {
        if (slotCount < 1) {
