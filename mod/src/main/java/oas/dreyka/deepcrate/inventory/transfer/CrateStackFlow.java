package oas.dreyka.deepcrate.inventory.transfer;
 ...
 */
public final class CrateStackFlow {
    private final CrateStorage storage;

    public CrateStackFlow(CrateStorage storage) {
     ...
     */
    public ItemStack clampedToCapacity(ItemStack itemStack) {
        if (this.storage.accepts(itemStack)) {
            int limit = this.storage.capacityFor(itemStack);
