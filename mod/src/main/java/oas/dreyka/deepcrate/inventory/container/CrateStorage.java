package oas.dreyka.deepcrate.inventory.container;
...
import oas.dreyka.deepcrate.inventory.slot.CrateSlotCapacity;
import oas.dreyka.deepcrate.inventory.slot.CrateSlotResize;
import oas.dreyka.deepcrate.inventory.transfer.CrateStackFlow;
...
public final class CrateStorage {
    ...
    public void setSlots(NonNullList<ItemStack> nonNullList) {
