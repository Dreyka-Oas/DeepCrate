...
public class DeepCrateMenu extends AbstractContainerMenu {
    /** The halves of this menu, built around their own reference, as {@code CrateModuleHolder} is for a block entity. */
    ...
    public DeepCrateMenu(int i, Inventory inventory, Container container, List<DeepCrateBlockEntity> crates, CrateLayout crateLayout, int columns) {
